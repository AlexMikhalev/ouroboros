...
CHAPTER_BYTE_BUDGETS: dict[str, int] = {
    "docs/architecture/01-high-level-architecture.md": 161005,
    "docs/architecture/02-startup-onboarding-flow.md": 15517,
    "docs/architecture/03-web-ui-pages-and-buttons.md": 97130,
    "docs/architecture/04-server-api-endpoints.md": 26833,
    "docs/architecture/05-supervisor-loop.md": 27137,
    "docs/architecture/06-agent-core.md": 284715,
    ...
    "docs/development/06-rules-by-change-class.md": 93885,
