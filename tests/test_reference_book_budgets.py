...
CHAPTER_BYTE_BUDGETS: dict[str, int] = {
    "docs/architecture/01-high-level-architecture.md": 159876,
    "docs/architecture/02-startup-onboarding-flow.md": 15517,
    "docs/architecture/03-web-ui-pages-and-buttons.md": 95211,
    "docs/architecture/04-server-api-endpoints.md": 26833,
    "docs/architecture/05-supervisor-loop.md": 26450,
    "docs/architecture/06-agent-core.md": 283855,
    "docs/architecture/07-configuration.md": 36920,
    "docs/architecture/08-git-branching-ci-and-build.md": 18947,
    "docs/architecture/09-shutdown-and-process-cleanup.md": 12293,
    "docs/architecture/10-key-invariants.md": 17655,
    "docs/architecture/11-frozen-contracts-v1.md": 24377,
    "docs/architecture/12-host-service-companions-and-chat-ids.md": 11007,
    "docs/architecture/13-external-skills-layer.md": 7764,
    "docs/development/01-role-and-authority.md": 2375,
    "docs/development/02-naming-and-boundaries.md": 35528,
    "docs/development/03-module-size-and-complexity.md": 22519,
    "docs/development/04-core-governance-artifacts.md": 16431,
    "docs/development/05-review-and-commit-protocol.md": 12928,
    "docs/development/06-rules-by-change-class.md": 93471,
    ...
    "docs/development/11-design-system.md": 26211,
